	...
	return (
		<>
			<div className="modal-body">
				<form className="update-form">
					...
					<input
						...
						type="text"
						name="title"
						defaultValue={singlePostId.title}
						onChange={handleChange}
					/>
					<label className="pet">Pet</label>
					<input
						className="pet-update"
						type="text"
						name="pet"
						defaultValue={singlePostId.pet}
						onChange={handleChange}
					/>
					...
					<input
						...
						type="text"
						name="text"
						defaultValue={singlePostId.text}
						onChange={handleChange}
					/>
					...
					<input
						...
						type="text"
						name="category"
						defaultValue={singlePostId.category}
						onChange={handleChange}
					/>
				</form>
			</div>
			<div>
				...
				>
					<Link class="updateLink" to="/posts">
						Update Post
					</Link>
				</button>
				<button
